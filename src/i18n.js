...
const STRINGS = {
  pl: {
    ...
    THREAT_NONE: 'Żadne ze wschodnich województw nie jest podniesione.',
    THREAT_UA_LABEL: 'Alarm w Ukrainie:',
    THREAT_UA_DOWN: 'Źródło alarmów z Ukrainy niedostępne — poziom liczony tylko z ruchu ADS-B.',
    THREAT_FETCH_ERROR: 'Nie udało się pobrać oceny ryzyka.',
    THREAT_ADSB_LABEL: 'Maszyn wojskowych nad Polską:',
    THREAT_DISCLAIMER: 'Szacunek własny, nie komunikat urzędowy. Źródłem ostrzeżeń dla Polski pozostaje RCB.',
