...
const STRINGS = {
  ...
  en: {
    ...
    PUSH_IOS_INSTALL: 'On iPhone, notifications work only after adding the app to your home screen: in Safari open the Share menu → “Add to Home Screen”.',
    ...
    ALT_LEGEND_LABEL: 'ALTITUDE (AIRCRAFT COLOUR)',
