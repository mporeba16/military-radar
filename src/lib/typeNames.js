...
export function getCommonName(t) {
  ...
  const map = [
    ...
    [/^GLEX$|^GL5T$|^GL7T$|GLOBALEXPRESS|GLOBAL6000/, 'Global Express'],
    [/^LJ3[56]$|^C21$|LEARJET/, 'Learjet C-21'],
    [/^LJ(31|45|55|60|75)$/, 'Learjet'],
    ...
    [/^E3[A-Z]?$|^E3(TF|CF|DF|BF)$|SENTRY/, 'Sentry (AWACS)'],
    [/E737|WEDGETAIL/, 'Wedgetail'],
    [/^P8|POSEIDON/, 'Poseidon'],
    [/^P3|ORION/, 'Orion'],
    [/^E2[A-Z]?$|HAWKEYE/, 'Hawkeye'],
    [/^C2[A-Z]?$|GREYHOUND/, 'Greyhound'],
    // adsb.fi podaje desygnatory ICAO (R135, K35R), nie potoczne RC135/KC135 —
            // bez tych wariantów alert i powód mówiły surowym kodem typu.
    [/RC135|^R135$/, 'Rivet Joint'],
    [/JSTARS|^E8$|^E8C$/, 'J-STARS'],
    [/KC46|^K46$/, 'Pegasus'],
